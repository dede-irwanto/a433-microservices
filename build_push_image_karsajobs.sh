# Perintah untuk build Docker image  dengan nama ghcr.io/dede-irwanto/karsajobs:latest
docker build -t ghcr.io/dede-irwanto/karsajobs:latest .
...
docker push ghcr.io/dede-irwanto/karsajobs:latest
